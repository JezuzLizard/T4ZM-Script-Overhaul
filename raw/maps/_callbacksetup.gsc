...
SetDefaultCallbacks()
{
	...
	level.callbackStartGameType = maps\so\zm_common\_zm_callbacksetup::Callback_StartGameType;
	level.callbackSaveRestored = maps\so\zm_common\_zm_callbacksetup::Callback_SaveRestored;
	level.callbackPlayerConnect = maps\so\zm_common\_zm_callbacksetup::Callback_PlayerConnect;
	level.callbackPlayerDisconnect = maps\so\zm_common\_zm_callbacksetup::Callback_PlayerDisconnect;
	level.callbackPlayerDamage = maps\so\zm_common\_zm_callbacksetup::Callback_PlayerDamage;
	level.callbackPlayerKilled = maps\so\zm_common\_zm_callbacksetup::Callback_PlayerKilled;
	
	level.callbackPlayerLastStand = maps\so\zm_common\_zm_callbacksetup::Callback_PlayerLastStand;	
}
