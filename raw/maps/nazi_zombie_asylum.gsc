...
main()
{
	...
	if ( !isDefined( level.zm_custom_map_perk_vox ) )
	{
		level.zm_custom_map_perk_vox = [];
	}
	level.zm_custom_map_perk_vox[ "juggernog" ] = "vox_drink_jugga";
	level.zm_custom_map_perk_vox[ "revive" ] = "vox_drink_revive";
	level.zm_custom_map_perk_vox[ "doubletap" ] = "vox_drink_double";
	level.zm_custom_map_perk_vox[ "sleight" ] = "vox_drink_speed";
...
init_sounds()
{
	...
	maps\so\zm_common\_zm_utility::add_sound( "couch_slam", "couch_slam" );
...
asylum_add_weapons()
{
	...
	// Pistols
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "colt", 									&"ZOMBIE_WEAPON_COLT_50", 					50,		"vox_crappy", 4 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "colt_dirty_harry", 						&"ZOMBIE_WEAPON_COLT_DH_100", 				100,	"vox_crappy", 4 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "nambu", 								&"ZOMBIE_WEAPON_NAMBU_50", 					50, 	"vox_crappy", 4 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "sw_357", 								&"ZOMBIE_WEAPON_SW357_100", 				100, 	"vox_357", 5 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "tokarev", 								&"ZOMBIE_WEAPON_TOKAREV_50", 				50, 	"vox_crappy", 4 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "walther", 								&"ZOMBIE_WEAPON_WALTHER_50", 				50, 	"vox_crappy", 4 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "zombie_colt", 							&"ZOMBIE_WEAPON_ZOMBIECOLT_25", 			25, 	"vox_crappy", 4 );
	...
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "type99_rifle", 							&"ZOMBIE_WEAPON_TYPE99_200", 				200,	"", 0 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "type99_rifle_bayonet", 					&"ZOMBIE_WEAPON_TYPE99_B_200", 				200,	"", 0 );

	// Semi Auto                                        		
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "gewehr43", 								&"ZOMBIE_WEAPON_GEWEHR43_600", 				600,	"" , 0 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "m1carbine", 							&"ZOMBIE_WEAPON_M1CARBINE_600",				600,	"" , 0 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "m1carbine_bayonet", 					&"ZOMBIE_WEAPON_M1CARBINE_B_600", 			600,	"" , 0 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "m1garand", 								&"ZOMBIE_WEAPON_M1GARAND_600", 				600,	"" , 0 );
	...
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "molotov", 								&"ZOMBIE_WEAPON_MOLOTOV_200", 				200,	"vox_crappy", 4 );
	...
	// Scoped
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "kar98k_scoped_zombie", 					&"ZOMBIE_WEAPON_KAR98K_S_750", 				750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "kar98k_scoped_bayonet_zombie", 			&"ZOMBIE_WEAPON_KAR98K_S_B_750", 			750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "mosin_rifle_scoped_zombie", 			&"ZOMBIE_WEAPON_MOSIN_S_750", 				750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "mosin_rifle_scoped_bayonet_zombie", 	&"ZOMBIE_WEAPON_MOSIN_S_B_750", 			750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "ptrs41_zombie", 						&"ZOMBIE_WEAPON_PTRS41_750", 				750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "springfield_scoped_zombie", 			&"ZOMBIE_WEAPON_SPRINGFIELD_S_750", 		750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "springfield_scoped_bayonet_zombie", 	&"ZOMBIE_WEAPON_SPRINGFIELD_S_B_750", 		750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "type99_rifle_scoped_zombie", 			&"ZOMBIE_WEAPON_TYPE99_S_750", 				750,	"vox_sniper", 5);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "type99_rifle_scoped_bayonet_zombie", 	&"ZOMBIE_WEAPON_TYPE99_S_B_750", 			750,	"vox_sniper", 5);

	// Full Auto                                                                                	
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "mp40", 								&"ZOMBIE_WEAPON_MP40_1000", 				1000,	"", 0 ); 
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "ppsh", 								&"ZOMBIE_WEAPON_PPSH_2000", 				2000,	"", 0 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "stg44", 							&"ZOMBIE_WEAPON_STG44_1200", 				1200,	"", 0 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "thompson", 							&"ZOMBIE_WEAPON_THOMPSON_1500", 			1500,	"", 0 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "type100_smg", 						&"ZOMBIE_WEAPON_TYPE100_1000", 				1000,	"", 0 );

	// Shotguns                                         	
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "doublebarrel", 						&"ZOMBIE_WEAPON_DOUBLEBARREL_1200", 		1200,	"vox_shotgun", 4);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "doublebarrel_sawed_grip", 			&"ZOMBIE_WEAPON_DOUBLEBARREL_SAWED_1200", 	1200,	"vox_shotgun", 4);
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "shotgun", 							&"ZOMBIE_WEAPON_SHOTGUN_1500", 				1500,	"vox_shotgun", 4);

	// Heavy Machineguns                                	
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "30cal", 							&"ZOMBIE_WEAPON_30CAL_3000", 				3000,	"vox_mg", 5 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "bar", 								&"ZOMBIE_WEAPON_BAR_1800", 					1800,	"vox_mg", 5 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "dp28", 								&"ZOMBIE_WEAPON_DP28_2250", 				2250,	"vox_mg" , 5 );
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "fg42", 								&"ZOMBIE_WEAPON_FG42_1200", 				1500,	"vox_mg" , 5 ); 
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "fg42_scoped", 						&"ZOMBIE_WEAPON_FG42_S_1200", 				1500,	"vox_mg" , 5 ); 
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "mg42", 								&"ZOMBIE_WEAPON_MG42_1200", 				3000,	"vox_mg" , 5 ); 
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "type99_lmg", 						&"ZOMBIE_WEAPON_TYPE99_LMG_1750", 			1750,	"vox_mg" , 5 ); 

	// Grenade Launcher                                 	
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "m1garand_gl_zombie", 						&"ZOMBIE_WEAPON_M1GARAND_GL_1200", 	1200,	"", 0 );
	...
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "bar_bipod", 						&"ZOMBIE_WEAPON_BAR_BIPOD_2500", 			2500,	"vox_mg", 5 ); 
	...
	// Rocket Launchers
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "bazooka", 							&"ZOMBIE_WEAPON_BAZOOKA_2000", 				2000,	"", 4 ); 
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "panzerschrek_zombie", 						&"ZOMBIE_WEAPON_PANZERSCHREK_2000", 		2000,	"", 4 ); 

	// Flamethrower                                     	
	maps\so\zm_common\_zm_weapons::add_zombie_weapon( "m2_flamethrower_zombie", 			&"ZOMBIE_WEAPON_M2_FLAMETHROWER_3000", 		3000,	"vox_flame", 5);	
...
asylum_init_zombie_leaderboard_data()
{
