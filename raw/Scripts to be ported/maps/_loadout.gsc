...
init_loadout()
{
	...
	else if (level.campaign == "american")
	{
		...
		else if( level.script == "nazi_zombie_coast" || level.script == "nazi_zombie_paris" || level.script == "nazi_zombie_sumpf" || level.script == "nazi_zombie_asylum" || level.script == "nazi_zombie_factory" || level.script == "zombie_test_map" || level.script == "nazi_zombie_theater" )
		{
